...
export default function Footer() {
    return (
        <>
            <div className="bg-[#212121] py-12 px-8 md:px-16 text-gray-300">
                ...
                <footer className="grid grid-cols-6 gap-4">
                    <aside className="col-span-6 md:col-span-2 max-w-64">
                    ...
                    <nav className="col-span-3 md:col-span-1 flex flex-col space-y-4">
            ...
            <div className="bg-gray-100 px-8 mdpx-16 py-4 flex flex-col md:flex-row justify-between">
