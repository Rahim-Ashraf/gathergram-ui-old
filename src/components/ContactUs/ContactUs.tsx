...
export default function ContactUs() {
    return (
        <div className="py-8 max-w-screen-lg mx-auto space-y-4">
            ...
            <div className="flex gap-6">
                <div className="space-y-2 px-4 py-8 bg-pink-50">
                    <div className="w-12 pb-8">
                        <img src={chat} alt="Icon" />
                    </div>
                    <h4 className="text-xl">Chat to sales</h4>
                ...
                <div className="space-y-2 px-4 py-8 bg-pink-50">
                    ...
                    <h4 className="text-xl">Chat to support</h4>
                ...
                <div className="space-y-2 px-4 py-8 bg-pink-50">
                    ...
                    <h4 className="text-xl">Visit us</h4>
